...
class ControladorResultado():
    ...
    def update(self,id,infoResultado):
        ...
        ResultadoActual.id_resultado=infoResultado["_id_resultado"]
        ResultadoActual.id_mesa = infoResultado["_id_mesa"]
        ResultadoActual.id_candidato = infoResultado["_id_candidato"]
